...
namespace DFS
{
    internal class Program
    {
         ...
         * 
         * Hodně štěstí s psaním a pište prosím bez ChatGPT! :)
        ...
        static List<int> DepthFirstSearch(BinaryTree graph, int targetNodeIndex)
        {
            ...
            while (true)
            {
                ...
                else
                {
                    ...
                    { 
                        //pokud dítě není v navštívených
                        if (!currentNode.visitedChildren.Contains(child)) 
                        { 
                            //hodim toto dítě do navštívených
                            //a nastacím currentNode na to dítě....
                        }
                    }
                    //pokdu nemáme nenavštívené dítě(to musíš nějak zjistit myslím....), tak nastavujeme na rodiče currentNode = currentNode.parent
                }
